...
public class TransactionSummaryDaoIT {
    ...
    public void shouldReturnPaymentsStatisticsForSuccessfulPayments_whenSearchingWithNoParameters() {
        ...
        var query = new TransactionSummaryStatisticQuery();

        TransactionsStatisticsResult paymentsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(query, TransactionType.PAYMENT);
    ...
    public void shouldReturnPaymentsStatistics_whenSearchingByGatewayAccount() {
        ...
        assertThat(paymentsStatistics.getGrossAmount(), is(1000L));
    }
    ...
    public void shouldReturnPaymentsStatistics_whenSearchingByFromDateAndToDate() {
        ...
        var query = new TransactionSummaryStatisticQuery()
                .withFromDate("2019-09-29T10:00:00Z")
                .withToDate("2019-10-01T10:00:00Z");

        TransactionsStatisticsResult paymentsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(query, TransactionType.PAYMENT);

        assertThat(paymentsStatistics.getCount(), is(3L));
        assertThat(paymentsStatistics.getGrossAmount(), is(6000L));
    }
    ...
    public void shouldReturnTransactionsSummary_whenSearchingByFromDate() {
        ...
        var queryWithoutMoto = new TransactionSummaryStatisticQuery()
                .withAccountId(gatewayAccountId)
                .withFromDate("2019-09-29T10:00:00Z");

        var queryWithMoto = new TransactionSummaryStatisticQuery()
                .withAccountId(gatewayAccountId)
                .withMoto(true)
                .withFromDate("2019-09-29T10:00:00Z");

        TransactionsStatisticsResult paymentsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(queryWithoutMoto, TransactionType.PAYMENT);
        assertThat(paymentsStatistics.getCount(), is(3L));
        assertThat(paymentsStatistics.getGrossAmount(), is(9000L));

        TransactionsStatisticsResult refundsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(queryWithoutMoto, TransactionType.REFUND);
        assertThat(refundsStatistics.getCount(), is(1L));
        assertThat(refundsStatistics.getGrossAmount(), is(1000L));

        TransactionsStatisticsResult motoPaymentsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(queryWithMoto, TransactionType.PAYMENT);
        assertThat(motoPaymentsStatistics.getCount(), is(1L));
        assertThat(motoPaymentsStatistics.getGrossAmount(), is(1000L));
    }

    @Test
    public void shouldReturnSingleTransactionsSummary_whenFromAndToDateAreIdentical() {
        String gatewayAccountId = RandomStringUtils.randomAlphanumeric(10);
        ...
        var query = new TransactionSummaryStatisticQuery()
                .withAccountId(gatewayAccountId)
                .withFromDate("2019-09-29T10:00:00Z")
                .withToDate("2019-09-29T10:00:00Z");

        TransactionsStatisticsResult motoPaymentsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(query, TransactionType.PAYMENT);
        assertThat(motoPaymentsStatistics.getCount(), is(1L));
        assertThat(motoPaymentsStatistics.getGrossAmount(), is(2000L));
    }
    ...
    public void shouldSumAmountWhenTotalAmountIsNull() {
        ...
        TransactionsStatisticsResult refundsStatistics = transactionSummaryDao.getTransactionSummaryStatistics(query, TransactionType.REFUND);
        assertThat(refundsStatistics.getCount(), is(1L));
        assertThat(refundsStatistics.getGrossAmount(), is(1000L));
    }
}