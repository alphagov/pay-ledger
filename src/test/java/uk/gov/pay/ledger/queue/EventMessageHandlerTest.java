...
class EventMessageHandlerTest {
    ...
    void shouldLogReasonIfAvailableOnEventData() throws QueueException {
        ...
        assertThat(loggingEventArgumentCaptor.getValue().getArgumentArray(), hasItemInArray(kv("reason", "a reason")));
    }
